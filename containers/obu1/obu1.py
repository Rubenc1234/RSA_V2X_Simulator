...
def main():
    ...
    # Use VEHICLE_NAME if available, fallback to MQTT_BROKER name
    # (both are usually e.g. "obu3")
    vehicle_name = os.environ.get(
        "VEHICLE_NAME",
        os.environ.get("MQTT_BROKER", "obu1"),
    )
